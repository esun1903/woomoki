...
public class ChallengeDto {
	...
	public String toString() {
		return "ChallengeDto [id=" + id + ", category_id=" + category_id + ", user_id=" + user_id + ", title=" + title
				+ ", content=" + content + ", sum_img=" + sum_img + ", start_date=" + start_date + ", end_date="
				+ end_date + ", cert_count=" + cert_count + ", max_people=" + max_people + ", example_img=" + example_img
